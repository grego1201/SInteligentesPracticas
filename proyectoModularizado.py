	...
	def __init__(self,imagen_o,imagen_p, columnas, filas):
		...
		if self.obtener_datos(imagen_o, imagen_p):
			...
			if self.comprobar_imagenes():
				...
				tiempoInicial = time()
				self.limitarMemoria(5<<30) # 1 para cantidad y 30 para unidad ( 1 giga)
				...
				try:
					...
					while True:
						...
						if nodos%100==0:
							tiempoNodo = time() - tiempoNodo
							print "nodos insertados: " +  str(nodos) + ". Tiempo insercion: " +str(tiempoNodo) + " segundos"
